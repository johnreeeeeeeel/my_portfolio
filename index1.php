...
<body class="container-fluid">
    ...
    <div class="offcanvas offcanvas-start" id="sidebarMobile">
        ...
        <div class="offcanvas-body">
            <img class="profile-img" src="assets/images/profile.png" alt="Profile Image">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="home">
                <?php
                    ...
                    if ($hour < 12) {
                        $bg = "assets/images/morning.png";
                        $greet = "Good Morning!";
                    } elseif ($hour < 18) {
                        $bg = "assets/images/afternoon.png";
                        $greet = "Good Afternoon!";
                    } else {
                        $bg = "assets/images/night.png";
                        $greet = "Good Evening!";
                    }
                ?>
